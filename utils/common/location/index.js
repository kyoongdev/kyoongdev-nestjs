...
let Location = class Location {
    ...
    setKakaoHeader(kakaoRestKey) {
        if (!this.kakaoRestKey && kakaoRestKey)
    ...
    getKakaoLocationByAddress({ address, analyze_type = 'similar', page = 1, limit = 20, kakaoRestKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield kakaoApi.get(url, { headers: this.headers });
            if (!response)
                return null;
    ...
    getKakaoLocationByKeyword({ keyword, latitude, longitude, radius = 200, page = 1, limit = 20, kakaoRestKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield kakaoApi.get(kakaoUrl, { headers: this.headers });
            if (!response)
                return null;
    ...
    getGoogleLocationByGeocode({ googleRestKey, latitude, longitude }) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (!googleRestKey && this.googleRestKey)
