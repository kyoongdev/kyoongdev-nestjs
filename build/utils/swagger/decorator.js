...
const RequestApi = (swaggerOptions) => {
    ...
    return (target, key, descriptor) => {
        if (summary) {
            Reflect.defineMetadata(constants_1.DECORATORS.API_OPERATION, (0, lodash_1.pickBy)(Object.assign({ summary: '' }, summary), (0, lodash_1.negate)(lodash_1.isUndefined)), descriptor.value);
        }
